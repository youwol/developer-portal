...
const externals = {
    ...
    "@youwol/grapes-coding-playgrounds": "window['@youwol/grapes-coding-playgrounds_APIv03']",
...
export const setup = {
    ...
    installAuxiliaryModule: ({name, cdnClient, installParameters}:{
        ...
        const scripts = [
            ...(parameters.scripts || []),
            `@youwol/developer-portal#0.2.3-wip~dist/@youwol/developer-portal/${entry.name}.js`
        ]
        const modules = [
            ...(parameters.modules || []),
